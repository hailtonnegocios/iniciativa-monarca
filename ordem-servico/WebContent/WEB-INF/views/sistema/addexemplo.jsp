...
-->
	...
	<form role="form" action="addexe1" method="post">
		...
		<label><fmt:message key="sistema.modelo.campo.ativado" /></label> <input type="checkbox" class="myClass"
			value="true" id="status" name="status" data-color="green" /> <br>
			<br>
		...
		<br> <label><fmt:message key="sistema.modelo.campo.nome" /></label> <input class="form-control"
			type="text" name="nome" id="nome" /> <br> 
