//  ---------------------------  FUN��ES RELACIONADAS A TELA DE EXEMPLOS COM AJAX --------------------------------  

         
	      // AO CLICAR NO PRIMEIRO EXEMPLO SER� MANDADA UMA REQUISI��O AO M�TODO  funcAjax1 NO CONTROLLER
		  $("#ajax1").hide();
		  ...
		  // AO CLICAR NO SEGUNDO EXEMPLO SER� MANDADA UMA REQUISI��O AO M�TODO  funcAjax2 NO CONTROLLER
		  $("#ajax2").hide();
		  $("#carregando1").hide();
		  $("#btnTeste2").click(function() {
		    ...
		    // AO CLICAR NO TERCEIRO EXEMPLO SER� MANDADA UMA REQUISI��O AO M�TODO  funcAjax3 NO CONTROLLER
			$("#ajax3").hide();
			$("#carregando2").hide();
			$("#btnTeste3").click(function() {
  		    ...
  		    // AO CLICAR NO QUARTO EXEMPLO SER� MANDADA UMA REQUISI��O AO M�TODO  funcAjax4 NO CONTROLLER
			$("#ajax4").hide();
...
//  ---------------------------  FUN��ES RELACIONADAS A TELA DE cadastroExemplo -------------------------------------------------------------	
			
			
  		    // AO CLICAR NO BOT�O DE PESQUISAR DA TELA DE cadastroExemplo , SER� LISTADO TODOS OS EXEMPLOS COM RELA��O AO FILTRO ESCOLHIDO  
			...
			// AO CLICAR NO BOT�O DO MODAL A ROTINA ABAIXO SER� EXECUTADA  
			...
			// CRIA��O DA TABELA DE EXEMPLOS COM O RETORNO DO AJAX SEM OS BOT�ES DE ALTERAR E EXCLUIR
			...
			// CRIA��O DA TABELA DE EXEMPLOS COM O RETORNO DO AJAX COM OS BOT�ES DE ALTERAR E EXCLUIR			
			...
			function retornaSelecionados(){
				  ...
				  for(i=0;i<inputs.length;i++){
				    // v�o ser marcados somente os check que iniciam com id = check, ou seja, se caso outro check estiver com outro id n�o ser� marcado
